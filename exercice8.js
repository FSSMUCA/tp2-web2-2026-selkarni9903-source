...
let emailValide = indexArrobase !== -1 && email.indexOf(".", indexArrobase) !== -1;
...
let derniereConnexionVal = derniereConnexion ?? "Jamais connecté";

let nbConnexionsNum = parseInt(nombreConnexions);
...
console.log("age              :", ageValide ? ageNum : "valeur invalide", ageValide ? "(valide)" : "(invalide)");
...
console.log("derniereConnexion:", `"${derniereConnexionVal}" (valeur par défaut via ??)`);
